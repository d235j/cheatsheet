...
\newcommand{\closeul}[1]{\underline{\smash{#1}}}
...
\begin{tabular}{@{}p{\the\MyLen}%
                @{}p{\linewidth-\the\MyLen}@{}}
\texttt{\href{http://www.ros.org/wiki/rospack}{rospack}/\href{http://www.ros.org/wiki/rosstack}{rosstack}} & A tool inspecting \href{http://www.ros.org/wiki/Packages}{packages}/\href{http://www.ros.org/wiki/Stacks}{stacks}. \\
...
\texttt{\href{http://wiki.ros.org/catkin/commands/catkin\_make}{catkin\_make}} & Builds code in a \href{http://wiki.ros.org/catkin}{Catkin} workspace. \\
\texttt{\href{http://wiki.ros.org/ROS/Tutorials/catkin/CreatingPackage\#Creating\_a\_catkin\_Package}{catkin\_create\_pkg}} & Creates a new \href{http://wiki.ros.org/catkin}{Catkin} package. \\
\texttt{\href{http://www.ros.org/wiki/roscreate}{roscreate}-pkg} & Creates a new legacy ROS package. \\
...
\texttt{\href{http://www.ros.org/wiki/rqt\_dep}{rqt\_dep}} & Displays package structure and dependencies.\\
\end{tabular}

\begin{tabbing}
Us\=age:\\
\> \texttt{\$ rospack find \closeul{package}}\\  
\> \texttt{\$ roscd \closeul{package}[/subdir]}\\
\> \texttt{\$ rosls \closeul{package}[/subdir]}\\
\> \texttt{\$ catkin\_make}\\
\> \texttt{\$ catkin\_create\_pkg \closeul{package\_name} [depend1]... }\\
\> \texttt{\$ roscreate-pkg \closeul{package\_name}}\\
\> \texttt{\$ rosmake \closeul{package}}\\
\> \texttt{\$ rosdep install \closeul{package}}\\
\> \texttt{\$ roswtf [file]}\\
\> \texttt{\$ rosrun rqt\_dep rqt\_dep [options]}
\end{tabbing}
...
\subsection{\href{http://www.ros.org/wiki/rqt\_plot}{rqt\_plot}}
A tool for plotting data from one or more ROS topic fields using pyqtgraph or matplotlib.\\
\vspace{2.5 mm}
...
\vspace{-1.5 mm}
\subsection{\href{http://www.ros.org/wiki/rqt\_graph}{rqt\_graph}}
...
\vspace{-1.5 mm}
\subsection{\href{http://www.ros.org/wiki/rqt\_bag}{rqt\_bag}}
...
\vspace{-1.5 mm}
\subsection{\href{http://www.ros.org/wiki/rqt\_console}{rqt\_console}}
...
\subsection{\href{http://wiki.ros.org/rviz}{rviz}}
A 3D visualization environment that lets you combine sensor data, robot model, and other 3D data into a combined view. You can also send your own 3D markers into rviz from your software.\\
\vspace{2.5 mm}
\includegraphics[width=.75\columnwidth]{rviz.png}
\begin{tabbing}
Us\=age:\\
\> \texttt{\$ rosrun rviz rviz}
\end{tabbing}
...
\section{\href{http://wiki.ros.org/ROS/Tutorials/MultipleMachines}{Multiple Machines}}
\vspace{2.5 mm}
\begin{tabbing}
En\=vironment variables:\\
\> \texttt{\href{http://wiki.ros.org/ROS/EnvironmentVariables\#ROS\_MASTER\_URI}{ROS\_MASTER\_URI}}: XML-RPC URI of the master node.\\
\> \texttt{http://hostname\_or\_ip\_address:11311}\\
One of the following:\\
\> \texttt{\href{http://wiki.ros.org/ROS/EnvironmentVariables\#ROS\_IP.2BAC8-ROS\_HOSTNAME}{ROS\_IP}}: The current node's IP address.\\
\> \texttt{\href{http://wiki.ros.org/ROS/EnvironmentVariables\#ROS\_IP.2BAC8-ROS\_HOSTNAME}{ROS\_HOSTNAME}}: The current node's hostname.\\
\end{tabbing}
...
Copyright \copyright\ 2010-2014 Willow Garage
\vspace{3000 mm}
